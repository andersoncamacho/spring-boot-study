...
public class CustomerController {
    ...
    public static final List<String> NAMES = List.of("Anderson", "Renan", "Felipe", "João", "Ronaldo");
    ...
    public List<String> filterOption(@RequestParam Optional<String>name) {
        return NAMES.stream().filter(n -> n.equalsIgnoreCase(name.orElse(""))).toList();
    }

    @GetMapping("filterList")
    public List<String> filterOption(@RequestParam List<String>names) {
